"""
Django settings for SmsPanel project.
...
SECRET_KEY = '%ydb)36g1&f)0#gpl0cx(ttnqc@_ik(c9nt1*w==kjc8lt3b73'
...
WSGI_APPLICATION = 'SmsPanel.wsgi.application'
...
# For loading Crispy Bootstrap Package
...
# For Production quality email service ... ( SendGrid, MailGun, Mandrill)
